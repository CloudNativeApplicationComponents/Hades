...
{
    internal class EventServerChannelFactory :
        IHadesServerChannelFactory<IEventServerChannel, IEventHandler, ISingleEndpointObservable, NopEndpointWriter>,
        IEventServerChannelFactory
    {
        public IEventServerChannel Create(
            IEventHandler handler,
            IServerEndpointAccessor<ISingleEndpointObservable, NopEndpointWriter> accessor)
        {
            _ = handler
            ...
            return new EventServerChannel(handler, accessor);
        }
    }
}
